        ...
        <div className="page1">
          <div className={styles.poster}>
            ...
            <img
              ...
              src="https://www.themoviedb.org/t/p/w1920_and_h600_multi_faces_filter(duotone,00192f,00baff)/hoVj2lYW3i7oMd1o7bPQRZd1lk1.jpg"
              alt=""
            />
          </div>
                  ...
                  <div key={movie.id} className={styles.movieBox}>
                    <Link href={`/movie/${movie.id}`}>
                      <div className={styles.moviePoster}>
                        <img
                          src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}?api_key=2a325f825de42d66968dbc58f1703c53`}
                          alt=""
                        />
